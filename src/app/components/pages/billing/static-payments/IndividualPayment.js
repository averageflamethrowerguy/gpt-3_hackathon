...
import PaymentButton from './IndividualPaymentButton'

import contextTypes from '../../../../contextTypes'

var discountCode = window.location.href.split('?')[1]

export default class IndividualPayment extends React.Component {
  ...
  renderPlanDescription = () => {
    ...
    return(
      <div>
        ...
        <p>Cost: ${this.state.paymentAmount} per month</p>
